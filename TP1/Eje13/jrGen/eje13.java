...
return null;
    ...
    private static Op_ext.JRProxyOp JRget_op_p3_voidTovoid()
    {
        return op_p3_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_p3_voidTovoid;
    static class ProcOp_voidTovoid_implp3 extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implp3(eje13 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje13.p3voidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje13.p3voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_p3_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implp3(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void p3voidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_p3_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void p3voidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                // Begin Expr2
    ...
    static {
        try {
            op_p3_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    private static void donevoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                float result = (x + 4) / ((int)Math.pow((y), (z)));
                // Begin Expr2
...
return null;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JReje13(op_done_voidTovoid, op_p3_voidTovoid, op_p2_voidTovoid, op_p1_voidTovoid);
    	this.JRcalled = true;
    }
