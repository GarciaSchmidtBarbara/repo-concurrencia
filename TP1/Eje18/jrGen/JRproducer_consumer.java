...
import java.io.Serializable;
    ...
    public class JRproducer_consumer
	...
	public Cap_ext_ op_puedoProducir_voidTovoid;
	public Cap_ext_ JRget_op_puedoProducir_voidTovoid() {
		return op_puedoProducir_voidTovoid;
	}
	public void JRset_op_puedoProducir_voidTovoid(Cap_ext_ op_puedoProducir_voidTovoid) {
		this.op_puedoProducir_voidTovoid = op_puedoProducir_voidTovoid;
	}

	public JRproducer_consumer(JRproducer_consumer copy)
	{
	...
	this.op_puedoProducir_voidTovoid = copy.op_puedoProducir_voidTovoid;

	}
	public JRproducer_consumer(Object ... opSig)
	{
	...
	this.op_puedoProducir_voidTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[5]);

	}
	public JRproducer_consumer(boolean dummy)	{
	    super(dummy);
	...
	this.op_puedoProducir_voidTovoid = Cap_ext_.noop;
	...
	{
	    return new JRproducer_consumer(true);
	}
    }
