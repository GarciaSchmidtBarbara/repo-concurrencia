...
public class producer_consumer extends java.lang.Object {
    { JRinit(); }
    ...
    private static Op_ext.JRProxyOp JRget_op_puedoProducir_voidTovoid()
    {
        return op_puedoProducir_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_puedoProducir_voidTovoid;
    ;
    static    {
        try    {
            op_puedoProducir_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 20;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_puedoProducir_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static Op_ext.JRProxyOp JRget_op_puedoConsumir_voidTovoid()
    {
        return op_puedoConsumir_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_puedoConsumir_voidTovoid;
    ;
    static    {
        try    {
            op_puedoConsumir_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_puedoConsumir_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    ...
    {
        public ProcOp_intTovoid_implpausa(producer_consumer thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                producer_consumer.pausaintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    producer_consumer.pausaintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private static Op_ext.JRProxyOp JRget_op_PProducer_voidTovoid()
    {
        return op_PProducer_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_PProducer_voidTovoid;
    static class ProcOp_voidTovoid_implPProducer extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implPProducer(producer_consumer thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                producer_consumer.PProducervoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    producer_consumer.PProducervoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_PProducer_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implPProducer(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void PProducervoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_PProducer_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void PProducervoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                int valor = 0;
                ...
                JRLoop0: while (true) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_puedoProducir_voidTovoid().recv();
                    ...
                    // Begin JRCall
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_pausa_intTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {1000});// End JRCall
                    
                    // Begin Expr2
                    valor++;
                    JRget_op_puedoConsumir_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                }
            }
        } catch (Exception JRe)    {
            if (retOp != null && fretOp == null)
    ...
    static {
        try {
            op_PProducer_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    private static Op_ext.JRProxyOp JRget_op_PConsumer_voidTovoid()
    {
        return op_PConsumer_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_PConsumer_voidTovoid;
    static class ProcOp_voidTovoid_implPConsumer extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implPConsumer(producer_consumer thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                producer_consumer.PConsumervoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    producer_consumer.PConsumervoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_PConsumer_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implPConsumer(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void PConsumervoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_PConsumer_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void PConsumervoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                int out = 0;
                JRLoop1: while (true) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_puedoConsumir_voidTovoid().recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    ...
                    // Begin JRCall
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_pausa_intTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {200});// End JRCall
                    
                    JRget_op_puedoProducir_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                }
            }
        } catch (Exception JRe)    {
            if (retOp != null && fretOp == null)
    ...
    static {
        try {
            op_PConsumer_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    {
        public ProcOp_voidTovoid_impldone(producer_consumer thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                producer_consumer.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    producer_consumer.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRproducer_consumer jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRproducer_consumer(op_done_voidTovoid, op_PConsumer_voidTovoid, op_PProducer_voidTovoid, op_pausa_intTovoid, op_puedoConsumir_voidTovoid, op_puedoProducir_voidTovoid);
    	this.JRcalled = true;
    }
