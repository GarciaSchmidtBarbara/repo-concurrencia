...
public class eje13 extends java.lang.Object {
    ...
    private static Despachador m = new Despachador("Monitor CPU");
    private static Op_ext.JRProxyOp JRget_op_Proceso_intTovoid()
    {
        return op_Proceso_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_Proceso_intTovoid;
    static class ProcOp_intTovoid_implProceso extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implProceso(eje13 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                eje13.ProcesointTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje13.ProcesointTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_Proceso_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implProceso(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void ProcesointTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_Proceso_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void ProcesointTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
    ...
    {
        public ProcOp_intTovoid_impldelay(eje13 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje13.delayintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje13.delayintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
...
return null;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JReje13(op_done_voidTovoid, op_delay_intTovoid, op_Proceso_intTovoid);
    	this.JRcalled = true;
    }
