...
class monitorSemaforo extends java.lang.Object {
    { JRinit(); }
    ...
    public void Msignal() {
        ...
        if (count <= 0) {
            // Begin Expr2
            (new Cap_ext_((colaProcesos).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);
        }
        // Begin Expr2
        m_next();
    }
    protected boolean JRcalled = false;
    protected JRmonitorSemaforo jrresref;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRmonitorSemaforo(op_m_urgentq_voidTovoid, op_m_mutex_voidTovoid);
    	this.JRcalled = true;
    }
