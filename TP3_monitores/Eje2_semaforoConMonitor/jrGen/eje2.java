...
public class eje2 extends java.lang.Object {
    { JRinit(); }
    ...
    private static monitorSemaforo m = new monitorSemaforo("Monitor LectoresEscritores");
    ...
    {
        public ProcOp_intTovoid_implEscritor(eje2 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                eje2.EscritorintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje2.EscritorintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    {
        public ProcOp_intTovoid_impldelay(eje2 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje2.delayintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje2.delayintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JReje2 jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JReje2(op_delay_intTovoid, op_Escritor_intTovoid);
    	this.JRcalled = true;
    }
