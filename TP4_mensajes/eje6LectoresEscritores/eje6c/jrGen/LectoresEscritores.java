...
public class LectoresEscritores extends java.lang.Object {
    ...
    private static Op_ext.JRProxyOp JRget_op_mnjLectorEscritor_javadotlangdotStringTovoid()
    {
        return op_mnjLectorEscritor_javadotlangdotStringTovoid;
    }
    
    public static Op_ext.JRProxyOp op_mnjLectorEscritor_javadotlangdotStringTovoid;
    ;
    static    {
        try    {
            op_mnjLectorEscritor_javadotlangdotStringTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
    ...
    public static void main(String... args) {
        JRget_op_mnjLectorEscritor_javadotlangdotStringTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {" "});
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                JRLoop1: while (true) {
                    ...
                    JRLoop0: while (cantEscritores > 0 || cantLectores > 0) {
                        ...
                        {
                            jrvm.sendAndDie();
                            Recv_ext recv_javadotlangdotStringTovoid = JRget_op_mnjLectorEscritor_javadotlangdotStringTovoid().recv();
                            aux = (java.lang.String) recv_javadotlangdotStringTovoid.JRargs[0];
                            jrvm.ariseAndReceive();
                            if (recv_javadotlangdotStringTovoid.retOp != null)
                                recv_javadotlangdotStringTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
...
return null;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRLectoresEscritores(op_pausa_intTovoid, op_Lector_intTovoid, op_Escritor_intTovoid, op_mutex_javadotlangdotStringTovoid, op_mnjLectorEscritor_javadotlangdotStringTovoid);
    	this.JRcalled = true;
    }
