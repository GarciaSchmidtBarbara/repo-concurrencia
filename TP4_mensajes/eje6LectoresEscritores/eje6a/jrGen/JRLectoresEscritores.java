...
import java.io.Serializable;
	...
	public Cap_ext_ op_mnjEscritor_javadotlangdotStringTovoid;
	public Cap_ext_ JRget_op_mnjEscritor_javadotlangdotStringTovoid() {
		return op_mnjEscritor_javadotlangdotStringTovoid;
	}
	public void JRset_op_mnjEscritor_javadotlangdotStringTovoid(Cap_ext_ op_mnjEscritor_javadotlangdotStringTovoid) {
		this.op_mnjEscritor_javadotlangdotStringTovoid = op_mnjEscritor_javadotlangdotStringTovoid;
	}

	public Cap_ext_ op_mnjLector_javadotlangdotStringTovoid;
	public Cap_ext_ JRget_op_mnjLector_javadotlangdotStringTovoid() {
		return op_mnjLector_javadotlangdotStringTovoid;
	}
	public void JRset_op_mnjLector_javadotlangdotStringTovoid(Cap_ext_ op_mnjLector_javadotlangdotStringTovoid) {
		this.op_mnjLector_javadotlangdotStringTovoid = op_mnjLector_javadotlangdotStringTovoid;
	}
	...
	this.op_mnjEscritor_javadotlangdotStringTovoid = copy.op_mnjEscritor_javadotlangdotStringTovoid;
	this.op_mnjLector_javadotlangdotStringTovoid = copy.op_mnjLector_javadotlangdotStringTovoid;
	...
	this.op_mnjEscritor_javadotlangdotStringTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[4]);
	this.op_mnjLector_javadotlangdotStringTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[5]);
	...
	this.op_mnjEscritor_javadotlangdotStringTovoid = Cap_ext_.noop;
	this.op_mnjLector_javadotlangdotStringTovoid = Cap_ext_.noop;
