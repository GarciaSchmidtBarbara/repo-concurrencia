...
public class ProducerConsumer extends java.lang.Object {
    ...
    public static void main(String... args) {
        JRLoop0: for (int i = 0; i < N; i++) JRget_op_mnjProduce_javadotlangdotStringTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {"msg:"});
...
return null;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRProducerConsumer(op_pausa_intTovoid, op_Consumer_intTovoid, op_Producer_intTovoid, op_mnjConsume_javadotlangdotStringTovoid, op_mnjProduce_javadotlangdotStringTovoid);
    	this.JRcalled = true;
    }
