...
public class ProducerConsumer extends java.lang.Object {
    ...
    public static void main(String... args) {
        JRLoop0: for (int i = 0; i < BUFFER_SIZE; i++) {
            JRget_op_mnjProduce_javadotlangdotStringTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {" "});
        }
    ...
    private Op_ext.JRProxyOp JRget_op_Producer_intTovoid()
    {
        return op_Producer_intTovoid;
    }
    
    public Op_ext.JRProxyOp op_Producer_intTovoid;
    class ProcOp_intTovoid_implProducer extends ProcOp_ext_impl
    {
        ProducerConsumer thisarg;
        public ProcOp_intTovoid_implProducer(ProducerConsumer thisIn) throws RemoteException
        {
        thisarg = thisIn;
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                thisarg.ProducerintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    thisarg.ProducerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private void ProducerintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_Producer_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private void ProducerintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                JRLoop1: while (true) {
                    ...
                    // Begin Expr2
                    e++;
                    JRget_op_mnjConsume_javadotlangdotStringTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {" "});
                    // Begin Expr2
    ...
    private Op_ext.JRProxyOp JRget_op_Consumer_intTovoid()
    {
        return op_Consumer_intTovoid;
    }
    
    public Op_ext.JRProxyOp op_Consumer_intTovoid;
    class ProcOp_intTovoid_implConsumer extends ProcOp_ext_impl
    {
        ProducerConsumer thisarg;
        public ProcOp_intTovoid_implConsumer(ProducerConsumer thisIn) throws RemoteException
        {
        thisarg = thisIn;
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                thisarg.ConsumerintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    thisarg.ConsumerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private void ConsumerintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_Consumer_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private void ConsumerintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                JRLoop2: while (true) {
                    ...
                    // Begin Expr2
                    cant--;
                    String data = buffer[ini];
                    // Begin Expr2
                    ini = (ini + 1) % BUFFER_SIZE;
                    JRget_op_mutex_javadotlangdotStringTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {" "});
                    // Begin Expr2
    ...
    {
        public ProcOp_intTovoid_implpausa(ProducerConsumer thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ProducerConsumer.pausaintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ProducerConsumer.pausaintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected void JRinit() {
    	...
    	try {
    	op_Consumer_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implConsumer(this));
    	op_Producer_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implProducer(this));
    	} catch (Exception JRe)
    	{ throw new jrRuntimeError(JRe.toString()); }
    	jrresref = new JRProducerConsumer(op_pausa_intTovoid, op_Consumer_intTovoid, op_Producer_intTovoid, op_mutex_javadotlangdotStringTovoid, op_mnjConsume_javadotlangdotStringTovoid, op_mnjProduce_javadotlangdotStringTovoid);
    	this.JRcalled = true;
    }
