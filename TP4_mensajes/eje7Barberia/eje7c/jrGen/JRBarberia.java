...
import java.io.Serializable;
	...
	public Cap_ext_ op_Cajero_voidTovoid;
	public Cap_ext_ JRget_op_Cajero_voidTovoid() {
		return op_Cajero_voidTovoid;
	}
	public void JRset_op_Cajero_voidTovoid(Cap_ext_ op_Cajero_voidTovoid) {
		this.op_Cajero_voidTovoid = op_Cajero_voidTovoid;
	}
	...
	public Cap_ext_ op_caja_intTovoid;
	public Cap_ext_ JRget_op_caja_intTovoid() {
		return op_caja_intTovoid;
	}
	public void JRset_op_caja_intTovoid(Cap_ext_ op_caja_intTovoid) {
		this.op_caja_intTovoid = op_caja_intTovoid;
	}
	...
	this.op_Cajero_voidTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[1]);
	this.op_Cliente_intTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[2]);
	this.op_Barbero_intTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[3]);
	this.op_caja_intTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[4]);
	this.op_puedoEsperar_intTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[5]);
