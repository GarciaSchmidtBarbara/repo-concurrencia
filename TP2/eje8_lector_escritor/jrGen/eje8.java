...
public class eje8 extends java.lang.Object {
    { JRinit(); }
    ...
    public static Op_ext.JRProxyOp op_puedoLeer_voidTovoid;
    ;
    static    {
        try    {
            op_puedoLeer_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = L;
    ...
    static Op_ext.JRProxyOp JRget_op_puedoEscribir_voidTovoid()
    {
        return op_puedoEscribir_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_puedoEscribir_voidTovoid;
    ;
    static    {
        try    {
            op_puedoEscribir_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
    ...
    {
        public ProcOp_intTovoid_implpausa(eje8 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                eje8.pausaintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje8.pausaintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private static Op_ext.JRProxyOp JRget_op_Escritores_intTovoid()
    {
    ...
    {
        public ProcOp_intTovoid_implEscritores(eje8 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje8.EscritoresintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje8.EscritoresintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void EscritoresintTovoid(java.lang.Object [] JRargs) {
        ...
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop0: while (true) {
                    ...
                    // Begin JRCall
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_pausa_intTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {tiempo});// End JRCall
    ...
    private static Op_ext.JRProxyOp JRget_op_Lectores_intTovoid()
    {
    ...
    {
        public ProcOp_intTovoid_implLectores(eje8 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje8.LectoresintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje8.LectoresintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void LectoresintTovoid(java.lang.Object [] JRargs) {
        ...
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop1: while (true) {
                    ...
                    // Begin Expr2
                    System.out.println("    Hay " + cantE + " lectores activos");
                    JRget_op_mutexE_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_mutexE_voidTovoid().recv();
    ...
    {
        public ProcOp_voidTovoid_impldone(eje8 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje8.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje8.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JReje8 jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JReje8(op_done_voidTovoid, op_Lectores_intTovoid, op_Escritores_intTovoid, op_pausa_intTovoid, op_mutexE_voidTovoid, op_puedoEscribir_voidTovoid, op_puedoLeer_voidTovoid);
    	this.JRcalled = true;
    }
