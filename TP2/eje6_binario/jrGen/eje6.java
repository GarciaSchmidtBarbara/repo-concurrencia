...
public class eje6 extends java.lang.Object {
    ...
    {
        public ProcOp_intTovoid_implpausa(eje6 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                eje6.pausaintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje6.pausaintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    {
        public ProcOp_intTovoid_implproceso(eje6 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje6.procesointTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje6.procesointTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
...
return null;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JReje6(op_done_voidTovoid, op_proceso_intTovoid, op_pausa_intTovoid, op_mutex_voidTovoid);
    	this.JRcalled = true;
    }
