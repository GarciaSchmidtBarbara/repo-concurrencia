...
public class eje9 extends java.lang.Object {
    { JRinit(); }
    ...
    Cap_ext_[] fork = new // NUMBER 8
    Cap_ext_[5];
    static {
        JRLoop0: for (int i = 0; i < 5; i++) {
            // Begin Expr2
            fork[i] = new Cap_ext_(new Op_ext_.JRProxyOp(InOp_ext_impl.create((1))));
        }
    }
    private static int veces = 20;
    private static Op_ext.JRProxyOp JRget_op_mutexV_voidTovoid()
    {
        return op_mutexV_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_mutexV_voidTovoid;
    ;
    static    {
        try    {
            op_mutexV_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_mutexV_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    
    private static void pensarintXintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_pensar_intXintTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void pensarintXintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
    ...
    private static Op_ext.JRProxyOp JRget_op_pensar_intXintTovoid()
    {
        return op_pensar_intXintTovoid;
    }
    
    public static Op_ext.JRProxyOp op_pensar_intXintTovoid;
    static class ProcOp_intXintTovoid_implpensar extends ProcOp_ext_impl
    {
        public ProcOp_intXintTovoid_implpensar(eje9 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                eje9.pensarintXintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje9.pensarintXintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_pensar_intXintTovoid = new Op_ext_.JRProxyOp(new ProcOp_intXintTovoid_implpensar(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    
    private static void comerintXintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_comer_intXintTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void comerintXintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int tiempo = ((Number) JRargs[0]).intValue();
    ...
    private static Op_ext.JRProxyOp JRget_op_comer_intXintTovoid()
    {
        return op_comer_intXintTovoid;
    }
    
    public static Op_ext.JRProxyOp op_comer_intXintTovoid;
    static class ProcOp_intXintTovoid_implcomer extends ProcOp_ext_impl
    {
        public ProcOp_intXintTovoid_implcomer(eje9 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje9.comerintXintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje9.comerintXintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_comer_intXintTovoid = new Op_ext_.JRProxyOp(new ProcOp_intXintTovoid_implcomer(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static Op_ext.JRProxyOp JRget_op_Filosofo_intTovoid()
    {
    ...
    {
        public ProcOp_intTovoid_implFilosofo(eje9 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje9.FilosofointTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje9.FilosofointTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void FilosofointTovoid(java.lang.Object [] JRargs) {
        ...
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop1: while (true) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_mutexV_voidTovoid().recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    if (veces <= 0) {
                        JRget_op_mutexV_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                        break JRLoop1;
                    }
                    // Begin Expr2
                    veces--;
                    ...
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = fork[i].recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    ...
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = fork[derecha].recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    ...
                    // Begin JRCall
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_comer_intXintTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {tiempo, i + 1});// End JRCall
                    
                    fork[i].send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    fork[derecha].send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    // Begin Expr2
                    tiempo = ((int)(Math.random() * 500)) + 100;
                    // Begin JRCall
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_pensar_intXintTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {tiempo, i + 1});// End JRCall
    ...
    {
        public ProcOp_voidTovoid_impldone(eje9 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje9.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje9.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JReje9 jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JReje9(op_done_voidTovoid, op_Filosofo_intTovoid, op_comer_intXintTovoid, op_pensar_intXintTovoid, op_mutexV_voidTovoid);
    	this.JRcalled = true;
    }
