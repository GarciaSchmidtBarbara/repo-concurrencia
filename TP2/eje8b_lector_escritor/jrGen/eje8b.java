...
public class eje8b extends java.lang.Object {
    ...
    static int cantL = 0;
    static Op_ext.JRProxyOp JRget_op_mutexL_voidTovoid()
    {
        return op_mutexL_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_mutexL_voidTovoid;
    ;
    static    {
        try    {
            op_mutexL_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_mutexL_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
...
return null;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JReje8b(op_done_voidTovoid, op_Lectores_intTovoid, op_Escritores_intTovoid, op_pausa_intTovoid, op_mutexE_voidTovoid, op_puedoEscribir_voidTovoid, op_mutexL_voidTovoid, op_puedoLeer_voidTovoid);
    	this.JRcalled = true;
    }
