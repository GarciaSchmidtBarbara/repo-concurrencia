...
public class eje5c extends java.lang.Object {
    { JRinit(); }
    ...
    private static Op_ext.JRProxyOp JRget_op_mutexC_voidTovoid()
    {
    ...
    private static Op_ext.JRProxyOp JRget_op_mutexP_voidTovoid()
    {
        return op_mutexP_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_mutexP_voidTovoid;
    ;
    static    {
        try    {
            op_mutexP_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_mutexP_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    ...
    {
        public ProcOp_intTovoid_implpausa(eje5c thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                eje5c.pausaintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje5c.pausaintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private static Op_ext.JRProxyOp JRget_op_PProducer_intTovoid()
    {
        return op_PProducer_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_PProducer_intTovoid;
    static class ProcOp_intTovoid_implPProducer extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implPProducer(eje5c thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje5c.PProducerintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje5c.PProducerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_PProducer_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implPProducer(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void PProducerintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_PProducer_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void PProducerintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                JRLoop0: while (true) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_mutexP_voidTovoid().recv();
                    ...
                    // Begin Expr2
                    valor++;
                    JRget_op_mutexP_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
    ...
    static {
        try {
            for (int i = 1; i <= N; i++) {
                op_PProducer_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    private static Op_ext.JRProxyOp JRget_op_PConsumer_intTovoid()
    {
        return op_PConsumer_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_PConsumer_intTovoid;
    static class ProcOp_intTovoid_implPConsumer extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implPConsumer(eje5c thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje5c.PConsumerintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje5c.PConsumerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_PConsumer_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implPConsumer(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void PConsumerintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_PConsumer_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void PConsumerintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop1: while (true) {
                    ...
                    int aux = ((Integer)buffer.removeFirst());
                    // Begin Expr2
    ...
    static {
        try {
            for (int i = 1; i <= M; i++) {
                op_PConsumer_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    {
        public ProcOp_voidTovoid_impldone(eje5c thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje5c.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje5c.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JReje5c jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JReje5c(op_done_voidTovoid, op_PConsumer_intTovoid, op_PProducer_intTovoid, op_pausa_intTovoid, op_mutexP_voidTovoid, op_mutexC_voidTovoid, op_puedoConsumir_voidTovoid);
    	this.JRcalled = true;
    }
