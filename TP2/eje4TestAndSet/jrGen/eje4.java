...
public class eje4 extends java.lang.Object {
    ...
    private static void pausavoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_pausa_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void pausavoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                try {
    ...
    private static Op_ext.JRProxyOp JRget_op_pausa_voidTovoid()
    {
        return op_pausa_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_pausa_voidTovoid;
    static class ProcOp_voidTovoid_implpausa extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implpausa(eje4 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                eje4.pausavoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje4.pausavoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_pausa_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implpausa(null));
    ...
    {
        public ProcOp_intTovoid_implProceso(eje4 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                eje4.ProcesointTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    eje4.ProcesointTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void ProcesointTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            ...
            {
                JRLoop1: while (true) {
                    JRLoop0: while (!TestAndSet()) // Begin JRCall
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_pausa_voidTovoid(), "void")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);// End JRCall
    ...
    static {
        try {
            for (int id = 0; id < 25; id++) {
                op_Proceso_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {id});
            }
...
return null;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JReje4(op_done_voidTovoid, op_Proceso_intTovoid, op_pausa_voidTovoid);
    	this.JRcalled = true;
    }
